...
ORDER BY DISCUSSION.DIS_ID DESC;

SELECT DISCUSSION.DIS_ID, USERS.NAME, DISCUSSION.DESCRIPTION, DISCUSSION.REPLY_COUNT
FROM DISCUSSION
JOIN USERSTARTDISCUSSION ON DISCUSSION.DIS_ID = USERSTARTDISCUSSION.DIS_ID
JOIN USERS ON USERSTARTDISCUSSION.USER_ID = USERS.USER_ID
WHERE DISCUSSION.PARENT_TOPIC = 312
...
SELECT COMPANYGIVENEWS.NEWS_ID, DESCRIPTION, HEADLINE, NEWS_DATE
FROM NEWSANDUPDATES JOIN COMPANYGIVENEWS 
    ON NEWSANDUPDATES.NEWS_ID = COMPANYGIVENEWS.NEWS_ID
WHERE COM_ID = 1;