  ...
  const [movies] = useState([
    {
      ...
      news: [
        {
          title:
            "News Title 1 News Title 1 News Title 1 News Title 1 News Title 1 ",
          description:
            '"The Boys" stars share which scene the superhero series should be known for and more in our interview with the cast.',
        },
        {
          title: "News Title 2",
          description:
  ...
  const [companies] = useState([
    {
      ...
      email: "s@gmail.com",
      description:
        "Example Productions is a leading film and TV production company known for its blockbuster movies and popular TV shows.",
      mediaId: [1, 2],
      news: [
        {
          id: 1,
          title: "Example Productions Acquires New Script",
          description:
            "Example Productions has acquired the script for a new action-packed movie set to release next summer.",
        },
        {
          id: 2,
          title: "New TV Show from Example Productions",
          description:
            "Example Productions announces a new TV show that will premiere this fall, featuring an all-star cast.",
        },
      ],
    ...
    },
    {
      ...
      email: "s@gmail.com",
      description:
        "DreamWorks Animation is an American animation studio that creates animated feature films, television programs, and online virtual games.",
      mediaId: [3, 4],
      news: [
        {
          id: 1,
          title: "DreamWorks Releases New Animated Feature",
          description:
            "DreamWorks Animation has released a new animated feature that is receiving rave reviews from critics and audiences alike.",
        },
        {
          id: 2,
          title: "DreamWorks Partners with New Streaming Service",
          description:
            "DreamWorks Animation has announced a new partnership with a leading streaming service to bring its animated movies and TV shows to a wider audience.",
        },
      ],
      productId: [6, 7, 8],
    },
        ...
        <Routes>
          ...
          {userType === "admin" && (
            <Route element={<LayoutAdmin />}>
              <Route
                path="/:username/home"
                element={<HomeAdmin movies={movies} />}
              />
          ...
          {userType === "merchandiser" && (
            <Route element={<LayoutMerch />}>
              <Route
                path="/:username/home"
                element={<HomeMerch movies={movies} />}
              />
