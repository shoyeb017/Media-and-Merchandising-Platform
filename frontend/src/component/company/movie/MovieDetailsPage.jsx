  ...
  return (
    <div className="movie-details-page">
     ...
     {/*##################  reviews section */}
      ...
      <h3 className="discussion-title">Add Discussion</h3>
      <div className="add-discussion">
        <h4>Add a Discussion</h4>
        <textarea
          placeholder="Heading"
          value={newDiscussion.heading}
          onChange={(e) => setNewDiscussion({ ...newDiscussion, heading: e.target.value })}
