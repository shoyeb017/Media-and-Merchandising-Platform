          ...
          <div className="top-news">
            ...
            {topNews.length > 0 ? (
              topNews.map((news, index) => (
                <Link
                  to={`/${username}/media/${news.MEDIA_ID}`}
                  className="link-product-card"
                >
                  <div className="news-item" key={index}>
                    <img
                      src={news.POSTER || "default-image-url"}
                      alt={news.HEADLINE}
                    />
                ...
                >
                  <div className="news-item-latest" key={index}>
                    ...
                    <div className="news-latest-content">
                      <p className="news-latest-content-title">
                        {news.HEADLINE}
                      </p>
                      <p className="news-latest-content-date">
                        {news.NEWS_DATE}
                      </p>
                      <p className="news-latest-content-desc">
                        {news.DESCRIPTION}
                      </p>
                    </div>
                  </div>
